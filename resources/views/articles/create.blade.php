  ...
  <div class="container">
    ...
    <div class="row mt-5 ">
      <div class="col-12">
        ...
        <h2 class="text-white text-center ">Inserisci un nuovo Articolo</h2>
    ...
    <div class="row">
      <div class="col-md-6 m-auto ">
        <form action="{{route('articles.store')}}" method="post" class="mt-3 " enctype="multipart/form-data">
          @csrf
          ...
          <div class="row g-3">
            ...
            <div class="col-12">
              ...
              <select class="form-select rounded-5 @error('category_id') is-invalid @enderror" aria-label="Default select example" name="category_id" id="category_id">
            ...
            <div class="col-12">
              ...
              <textarea name="description" id="description" rows="4" class="rounded-5 p-3 w-100 @error('description') is-invalid @enderror">{{ old('description') }}</textarea>
            ...
            <div class="col-12">
              ...
              <textarea name="body" id="body" rows="10" class="rounded-5 p-3 w-100 @error('body') is-invalid @enderror">{{ old('body') }}</textarea>
