    ...
    <div class="container-xl px-3 py-3">
        ...
        <div class="collapse navbar-collapse justify-content-between ms-md-1" id="navbarSupportedContent">
            ...
            <div class="row align-items-center justify-content-end ">
                <div class="col m-0 d-flex align-items-center justify-content-end  ">
                    <form class="d-flex m-0 align-items-center justify-content-end d-none d-xl-block" role="search">
